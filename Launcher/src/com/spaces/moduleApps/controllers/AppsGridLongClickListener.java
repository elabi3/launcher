...
public class AppsGridLongClickListener implements OnItemLongClickListener,
	...
	public boolean onItemLongClick(AdapterView<?> arg0, View view, int pos,
        ...
        ((ImageView) newView.findViewById(R.id.appIcon))
                .setOnClickListener(this);
        ((TextView) newView.findViewById(R.id.titleApp))
                .setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.detail:
			...
			break;
		default:
            intent = AppsManager.getInstance(mContext)
                    .getPackageManager()
                    .getLaunchIntentForPackage(appPack.getpackageName());
